...
import net.mcreator.immersionintrafficcontext.world.inventory.*;
...
public class ImmersionInTrafficContextModMenus {
	...
	public static final DeferredHolder<MenuType<?>, MenuType<Itc1Menu>> ITC_1 = REGISTRY.register("itc_1", () -> IMenuTypeExtension.create(Itc1Menu::new));
	public static final DeferredHolder<MenuType<?>, MenuType<Itc2Menu>> ITC_2 = REGISTRY.register("itc_2", () -> IMenuTypeExtension.create(Itc2Menu::new));
	public static final DeferredHolder<MenuType<?>, MenuType<Itc3Menu>> ITC_3 = REGISTRY.register("itc_3", () -> IMenuTypeExtension.create(Itc3Menu::new));
	public static final DeferredHolder<MenuType<?>, MenuType<TrafficLightMenu>> TRAFFIC_LIGHT = REGISTRY.register("traffic_light", () -> IMenuTypeExtension.create(TrafficLightMenu::new));
	public static final DeferredHolder<MenuType<?>, MenuType<Itc4Menu>> ITC_4 = REGISTRY.register("itc_4", () -> IMenuTypeExtension.create(Itc4Menu::new));
