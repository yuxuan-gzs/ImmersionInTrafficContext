...
public class ImmersionInTrafficContextModFluidTypes {
	...
	public static final DeferredHolder<FluidType, FluidType> LIQUID_BITUMEN_TYPE = REGISTRY.register("liquid_bitumen", () -> new LiquidBitumenFluidType());
	public static final DeferredHolder<FluidType, FluidType> ETHYLENE_TYPE = REGISTRY.register("ethylene", () -> new EthyleneFluidType());
}