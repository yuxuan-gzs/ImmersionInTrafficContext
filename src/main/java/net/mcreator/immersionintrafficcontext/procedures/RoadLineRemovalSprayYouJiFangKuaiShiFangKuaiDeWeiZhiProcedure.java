...
public class RoadLineRemovalSprayYouJiFangKuaiShiFangKuaiDeWeiZhiProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, ItemStack itemstack) {
		if (itemstack.getDamageValue() <= 294 && ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == ImmersionInTrafficContextModBlocks.WHITE_ZEBRA_CROSSING.get()
		...
		} else if (itemstack.getDamageValue() > 290) {
			itemstack.shrink(1);
		}
	}
}