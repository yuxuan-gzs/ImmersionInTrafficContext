...
public class Jei2RecipeCategory implements IRecipeCategory<Jei2Recipe> {
	public final static ResourceLocation UID = ResourceLocation.parse("immersion_in_traffic_context:jei_2");
	...
	public Jei2RecipeCategory(IGuiHelper helper) {
		this.background = helper.createDrawable(TEXTURE, 0, 0, 176, 76);
		this.icon = helper.createDrawableIngredient(VanillaTypes.ITEM_STACK, new ItemStack(ImmersionInTrafficContextModItems.SALT.get()));
	}

	@Override
	public mezz.jei.api.recipe.RecipeType<Jei2Recipe> getRecipeType() {
		return ImmersionInTrafficContextModJeiPlugin.Jei2_Type;
	}
	...
	@Override
	public void draw(Jei2Recipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
		this.background.draw(guiGraphics);

	}

	@Override
	public void setRecipe(IRecipeLayoutBuilder builder, Jei2Recipe recipe, IFocusGroup focuses) {
