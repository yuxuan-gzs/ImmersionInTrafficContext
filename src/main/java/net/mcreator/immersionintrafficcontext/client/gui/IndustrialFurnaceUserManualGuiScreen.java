...
public class IndustrialFurnaceUserManualGuiScreen extends AbstractContainerScreen<IndustrialFurnaceUserManualGuiMenu> implements ImmersionInTrafficContextModScreens.ScreenAccessor {
	...
	private static final ResourceLocation BACKGROUND = ResourceLocation.parse("immersion_in_traffic_context:textures/screens/industrial_furnace_user_manual_gui.png");
	private static final ResourceLocation IMAGE_0 = ResourceLocation.parse("immersion_in_traffic_context:textures/screens/2026-07-16_13.21.54.png");
	private static final ResourceLocation IMAGE_1 = ResourceLocation.parse("immersion_in_traffic_context:textures/screens/2026-07-16_13.23.05.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
		...
		guiGraphics.blit(IMAGE_0, this.leftPos + 101, this.topPos + 44, 0, 0, 213, 120, 213, 120);
		guiGraphics.blit(IMAGE_1, this.leftPos + -13, this.topPos + 49, 0, 0, 213, 120, 213, 120);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font, Component.translatable("gui.immersion_in_traffic_context.industrial_furnace_user_manual_gui.label_empty"), 149, 101, -12829636, false);
	}
