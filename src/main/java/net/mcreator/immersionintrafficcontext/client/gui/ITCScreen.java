...
public class ITCScreen extends AbstractContainerScreen<ITCMenu> implements ImmersionInTrafficContextModScreens.ScreenAccessor {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
		...
		if (Ci2Procedure.execute(entity)) {
			guiGraphics.blit(RenderType::guiTextured, ResourceLocation.parse("immersion_in_traffic_context:textures/screens/itc2.png"), this.leftPos + -67, this.topPos + 0, 0, 0, 292, 184, 292, 184);
		}
		if (Ci1Procedure.execute(entity)) {
			guiGraphics.blit(RenderType::guiTextured, ResourceLocation.parse("immersion_in_traffic_context:textures/screens/itc1.png"), this.leftPos + 0, this.topPos + 0, 0, 0, 146, 184, 146, 184);
		}
