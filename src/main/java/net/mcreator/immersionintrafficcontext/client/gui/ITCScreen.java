...
import net.mcreator.immersionintrafficcontext.network.ITCButtonMessage;
...
public class ITCScreen extends AbstractContainerScreen<ITCMenu> implements ImmersionInTrafficContextModScreens.ScreenAccessor {
	...
	private static final ResourceLocation BACKGROUND = ResourceLocation.parse("immersion_in_traffic_context:textures/screens/itc.png");
	private static final ResourceLocation IMAGE_0 = ResourceLocation.parse("immersion_in_traffic_context:textures/screens/itc1.png");
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int mouseX, int mouseY) {
		...
		if (Ci1Procedure.execute(world, x, y, z, entity)) {
			guiGraphics.blit(IMAGE_0, this.leftPos + 0, this.topPos + 0, 0, 0, 146, 184, 146, 184);
		}
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		...
		guiGraphics.drawString(this.font, Component.translatable("gui.immersion_in_traffic_context.itc.label_about"), 77, 73, -16777172, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.immersion_in_traffic_context.itc.label_machine_manual"), 50, 57, -16777172, false);
	}

	@Override
	public void init() {
		super.init();
		pagination = new EditBox(this.font, this.leftPos + 243, this.topPos + 190, 40, 20, Component.translatable("gui.immersion_in_traffic_context.itc.pagination"));
		...
		imagebutton_bb2 = new ImageButton(this.leftPos + 38, this.topPos + 71, 100, 16,
				new WidgetSprites(ResourceLocation.parse("immersion_in_traffic_context:textures/screens/bb1.png"), ResourceLocation.parse("immersion_in_traffic_context:textures/screens/bb2.png")), e -> {
					int x = ITCScreen.this.x;
					int y = ITCScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new ITCButtonMessage(1, x, y, z));
						ITCButtonMessage.handleButtonAction(entity, 1, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
		...
		imagebutton_bb21 = new ImageButton(this.leftPos + 38, this.topPos + 55, 100, 16,
				new WidgetSprites(ResourceLocation.parse("immersion_in_traffic_context:textures/screens/bb1.png"), ResourceLocation.parse("immersion_in_traffic_context:textures/screens/bb2.png")), e -> {
					int x = ITCScreen.this.x;
					int y = ITCScreen.this.y;
					if (true) {
						PacketDistributor.sendToServer(new ITCButtonMessage(2, x, y, z));
						ITCButtonMessage.handleButtonAction(entity, 2, x, y, z);
					}
				}) {
			@Override
			public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
